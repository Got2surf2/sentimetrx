...
const DECKS: Deck[] = [
  ...
  },
  {
    ...
    title: 'EA — Beyond the Score (NPS specific-emotion pitch)',
    subtitle: 'Proposal to run EA’s summer NPS as a regret-vs-disappointment engine. The moment (MVP Bundle vs closed-window MVP+) → the valence blind spot → the science (Zeelenberg & Pieters, 87.7%/900+) → the monopoly twist (captive licenses: regret→latent MVP+ demand, disappointment→recoverable) → behavioral map → real forum VoC → conversational mechanic → 3 segments (Convert/Recover/Warn) → corrective-action plays → proof → summer-wave pilot. 13 slides, editable PPTX. CUSTOMIZE: confirm contact before sending.',
    audience: 'EA — NPS / insights team, monopoly framing explicit',
    slides: '13 slides',
    accent: '#7C3AED',
    badge: 'EA · NPS',
