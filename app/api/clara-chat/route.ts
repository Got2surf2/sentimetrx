...
export async function POST(req: NextRequest) {
  ...
  const lastUserMsg = [...recentMessages].reverse().find((m: ClaraMessage) => m.role === 'user')
  if (lastUserMsg) {
...
${KNOWLEDGE_BASE}`,
    ...
    void logError('clara-chat.POST', err, { msg: 'Clara chat error:' })
