...
export async function POST(req: Request) {
  ...
  const prompt = `You are a qualitative research expert designing a discussion guide for a PulseIQ session.
...
{"topics":[{"label":"...","description":"...","opening_question":"...","follow_up_angles":["..."],"keywords":["..."]}]}`
  ...
  try {
    ...
    logUsage({ resource_type: 'townhall', event_type: 'suggest_guide' }, result.usage)
