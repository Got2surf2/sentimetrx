...
- _Phases 1–4 built + verified against Sarina (PDF + PPTX both visually QC'd page-by-page — clean cover/summary/section/bar-chart/theme-cards/verbatim-grid). The agent-card link lands in Phase 5._
