...
- _Phase 1 (compute core + cache) is built + verified against Sarina (49 useful conversations → 15 question themes, 12 beyond-themes). HTML/interactive page, PDF, and PPTX exports + the agent-card link land in later phases._
