...
│   ├── log.test.ts            # structured logger (lib/log) — Sentry capture tagged with where/request_id/org_id, never-throws, logWarn skips capture
