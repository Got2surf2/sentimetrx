...
- **Branding**: Sentimetrx throughout — the navy/teal/gold palette is unchanged
  ...
  "Senti·metrx"), the title-slide wordmark + "S" monogram, all footers
  (`sentimetrx.ai`, "Generated by Sentimetrx"), the About-slide methodology
  ("Sentimetrx AI Text Analytics"), and `pptx.author = pptx.company = 'Sentimetrx'`
  in file metadata. (W22 audit lift + 2026-06-02 deck-fix #9 — closed the last
  "datanautix.com" leaks the route and shared renderer still carried.)
