...
**Two comparison axes, tabbed** (`OutletReportTabs.tsx`, client; default tab **Themes**):
...
- **Summary** — a deterministic narrative (no AI) built from the rank/rating + the top theme & dimension deltas: "this location ranks #N…, stands out on X, trails on Y."
