...
| **Charts-tab design/correctness audit** | 2026-09-03 (fix set shipped same day) | All 13 chart types in `ChartsModule.tsx`: input validity, truncation honesty, statistical integrity, matcher consistency | `docs/ANALYTICS.md` "Charts audit fix set (2026-09-03)"; deferred items (saved-chart display options, time-series zero-fill, scatter overplotting, module split) in memory `project_charts_audit` | A new chart type ships, or a renderer adds its own truncation/ordering instead of `topCategoryKeys` |
