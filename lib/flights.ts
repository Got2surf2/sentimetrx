...
// 4-hour window — far enough out to cover boarding for almost any flight
// the user might mention, narrow enough that the response stays manageable
// (~250 flights right now).
