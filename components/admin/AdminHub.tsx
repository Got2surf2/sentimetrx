...
const CARDS: Card[] = [
  ...
  { category: 'operations', icon: '❤️', title: 'System Health',    description: 'Live system status in one place: database, vendor credits (Claude, DataForSEO, Deepgram, Twilio…), Sentry errors, and active-study response flow.', href: '/admin/health' },
