  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <TransitionMessagePanel
        enabled={!!(draft.config.sectionTransitions?.customQuestions?.enabled)}
        text={draft.config.sectionTransitions?.customQuestions?.text || ''}
        defaultText="Now for a few more specific questions."
        onToggle={v => updateConfig({ sectionTransitions: { ...draft.config.sectionTransitions, customQuestions: { enabled: v, text: draft.config.sectionTransitions?.customQuestions?.text || '' } } })}
        onTextChange={v => updateConfig({ sectionTransitions: { ...draft.config.sectionTransitions, customQuestions: { enabled: true, text: v } } })}
      />
