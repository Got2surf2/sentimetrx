...
const BANK: BankQuestion[] = [
  ...
  { key: 'i_ho_loyalty',  q: 'Are you a member of a hotel loyalty program?',                    opts: ['Yes — this hotel chain', 'Yes — a competitor', 'No but I am interested', 'No and not interested'],   exportLabel: 'Loyalty Program',         categories: ['industry'], industries: ['hospitality'] },

  // INDUSTRY — RESTAURANTS
  { key: 'i_rs_occasion', q: 'What best describes the occasion for your visit today?',           opts: ['Casual meal', 'Business lunch or dinner', 'Special occasion / celebration', 'Quick bite', 'Family meal'], exportLabel: 'Dining Occasion', categories: ['industry'], industries: ['casual_dining', 'fine_dining', 'fast_food'] },
  { key: 'i_rs_group',    q: 'How large was your dining party today?',                           opts: ['Just me', '2 people', '3–4 people', '5 or more people'],                                              exportLabel: 'Party Size',              categories: ['industry'], industries: ['casual_dining', 'fine_dining', 'fast_food'] },
  { key: 'i_rs_order',    q: 'How did you place your order today?',                              opts: ['Dine-in with server', 'Counter order', 'Mobile app', 'Third-party delivery', 'Drive-through'],        exportLabel: 'Order Method',            categories: ['industry'], industries: ['casual_dining', 'fine_dining', 'fast_food'] },
  { key: 'i_rs_diet',     q: 'Do you have any dietary preferences we should know about?',        opts: ['No restrictions', 'Vegetarian', 'Vegan', 'Gluten-free', 'Halal', 'Other dietary needs'],             exportLabel: 'Dietary Preference',      categories: ['industry'], industries: ['casual_dining', 'fine_dining', 'fast_food'] },

  // INDUSTRY — TRAVEL
  { key: 'i_tr_type',     q: 'What type of trip is this?',                                       opts: ['Solo travel', 'Couple', 'Family with children', 'Group of friends', 'Business travel'],             exportLabel: 'Trip Type',               categories: ['industry'], industries: ['travel_tourism'] },
  { key: 'i_tr_duration', q: 'How long is your trip?',                                           opts: ['Day trip', '2–3 nights', '4–7 nights', '1–2 weeks', 'More than 2 weeks'],                          exportLabel: 'Trip Duration',           categories: ['industry'], industries: ['travel_tourism'] },
  { key: 'i_tr_plan',     q: 'How far in advance did you plan this trip?',                       opts: ['Last minute (under a week)', '1–4 weeks', '1–3 months', 'More than 3 months'],                      exportLabel: 'Planning Lead Time',      categories: ['industry'], industries: ['travel_tourism'] },
  { key: 'i_tr_budget',   q: 'How would you describe your travel budget for this trip?',         opts: ['Budget / backpacker', 'Mid-range', 'Comfortable', 'Luxury'],                                         exportLabel: 'Travel Budget',           categories: ['industry'], industries: ['travel_tourism'] },

  // INDUSTRY — POLITICS
  { key: 'i_po_engage',   q: 'How do you most often engage with political issues?',              opts: ['Voting', 'Donating', 'Volunteering', 'Attending events', 'Sharing on social media', 'Following the news'], exportLabel: 'Political Engagement', categories: ['industry'], industries: ['political'] },
  { key: 'i_po_issues',   q: 'Which issues matter most to you right now?',                       opts: ['Economy and jobs', 'Healthcare', 'Education', 'Public safety', 'Environment', 'Immigration', 'Other'], exportLabel: 'Key Issues', categories: ['industry'], industries: ['political'] },
  { key: 'i_po_trust',    q: 'How much do you trust elected officials to act in your interest?', opts: ['A great deal', 'A fair amount', 'Not very much', 'Not at all'],                                       exportLabel: 'Institutional Trust',     categories: ['industry'], industries: ['political'] },

  // INDUSTRY — ENTERTAINMENT
  { key: 'i_en_type',     q: 'What type of event or entertainment brought you here today?',      opts: ['Concert or live music', 'Sports event', 'Theatre or performing arts', 'Film or cinema', 'Festival', 'Exhibit or museum', 'Other'], exportLabel: 'Entertainment Type', categories: ['industry'], industries: ['media_entertainment', 'performing_arts'] },
  { key: 'i_en_ticket',   q: 'How did you purchase your ticket or gain access?',                 opts: ['Online in advance', 'At the door / box office', 'Via a third-party app', 'Complimentary / guest list', 'Subscription or membership'], exportLabel: 'Ticket Channel', categories: ['industry'], industries: ['media_entertainment', 'performing_arts'] },
  { key: 'i_en_group',    q: 'Who did you come with today?',                                     opts: ['Alone', 'Partner or date', 'Friends', 'Family', 'Work colleagues'],                                   exportLabel: 'Attendance Group',        categories: ['industry'], industries: ['media_entertainment', 'performing_arts'] },
]
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <TransitionMessagePanel
        enabled={draft.config.sectionTransitions?.psychographics?.enabled !== false}
        text={draft.config.sectionTransitions?.psychographics?.text || ''}
        defaultText="Just a few quick questions to round things out -- helps us understand the range of people sharing feedback."
        onToggle={v => updateConfig({ sectionTransitions: { ...draft.config.sectionTransitions, psychographics: { enabled: v, text: draft.config.sectionTransitions?.psychographics?.text || '' } } })}
        onTextChange={v => updateConfig({ sectionTransitions: { ...draft.config.sectionTransitions, psychographics: { enabled: true, text: v } } })}
      />
      ...
      <NavButtons onBack={onBack} onNext={onNext} nextLabel="Next: Demographics" />
    </div>
  )
}
