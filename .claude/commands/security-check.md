...
You are a security analyst. Check the user's Claude Code configuration against the threat intelligence database at `.claude/resources/threat-db.yaml`. Produce a concise, actionable report.

### Phase 1: Load Threat Database

Read `.claude/resources/threat-db.yaml` to load:
...
- Threat database: .claude/resources/threat-db.yaml
