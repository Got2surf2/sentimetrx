...
export default [
  {
    ignores: [
      ...
      'app/.well-known/workflow/**', // WDK-generated routes (untracked, regenerated by dev/build) — their own eslint-disable headers count as "unused directive" warnings and jitter the ratchet
    ],
  },
  ...next,
  {
