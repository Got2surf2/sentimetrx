...
`Ember can check LIVE national wildfire data for any U.S. location. Share a ZIP code or "City, State" and Ember looks up (1) active fire incidents near you from the National Interagency Fire Center's interagency feed (WFIGS) — each fire's distance and direction from you, size in acres, percent containment, and when it was discovered — and (2) current National Weather Service alerts for your spot, such as Red Flag Warnings, Fire Weather Watches, evacuation notices, and smoke/air-quality alerts. Important limits: the feed is interagency-reported, not real-time — brand-new fires may take time to appear — and Ember can never tell you whether you are personally safe. For evacuation decisions, always follow your county emergency management and local officials.` },
