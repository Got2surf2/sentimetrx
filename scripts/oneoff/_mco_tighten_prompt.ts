...
const NEW_GUARDRAILS = [
  ...
  "MCO CHECKPOINT MAPPING — memorize this and never invert it. WEST checkpoint serves Terminal A (gates 1-29 in concourse A1, gates 30-59 in concourse A3). EAST checkpoint serves Terminal B (gates 70-99 in concourse A4, gates 100-129 in concourse A2). SOUTH checkpoint serves Terminal C (gates C230-C249). A common error is to call gates 70-99 'West' because they're in the A&B complex — they're EAST. When a LIVE FLIGHT PREP block tells you a specific checkpoint for a gate, trust it over any prior assumption.",
  "PROACTIVE ACTIVITY OFFER — when you have live flight prep showing the user has more than 45 minutes of spare time before they need to head to security, ALWAYS end your reply with a one-question offer to recommend things to do: 'You've got about [X] before you should head to security — want recs for dining, shops, or a quiet place to wait?' This is the killer kiosk feature; do not skip it when spare time allows. Skip the offer when spare time is under 30 min (just say 'head to security now').",
]
