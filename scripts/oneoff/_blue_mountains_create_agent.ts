...
`Both grazing and access were contested in the first (2004–2019) revision too — the 2018 plan drew objections that it restricted access and changed grazing management, part of the mix that led to the 2019 withdrawal. This round is a fresh set of choices, not a re-run of 2018: grazing is largely maintained in the proposed action (a substantial-reduction alternative was set aside), while access is handled with conditional language and deferred to future travel-management decisions, alongside undecided roadless/ROS classifications. So on both issues, "how is it different this time" comes down to these specific 2026 choices rather than the withdrawn 2018 plan's provisions.` },
  ...
  { title: 'Wildfire and fuels — the rationale, and the PACFISH/INFISH change', metadata: m({ kind: 'fire_detail' }), content:
`Wildfire is the stated rationale for the proposed action's active-management push. The Draft EIS notes dry upland forests could support more high-severity fire than in the past, and the proposed action (Alt 2) roughly triples logging with the aim of making the forests more resilient to wildfire, insects, and disease. A major, less-noticed change: alongside eliminating the 21-inch rule, the proposed action also removes PACFISH and INFISH — blanket 1990s rules that restrict logging near streams and wetlands to protect fish — and replaces them with "more flexible and nuanced" provisions. Proponents argue active management reduces catastrophic fire; critics worry fire resilience is used to justify logging older forests and streamside areas. Alternative 3 keeps firmer protections. If fire or salvage logging matters to you, say which alternative you prefer and why.` },

  { title: 'Wildlife habitat — species, standards, and the enforceable-standards debate', metadata: m({ kind: 'wildlife_detail' }), content:
`The plan sets wildlife direction for species including elk, bighorn sheep, marten, bats, raptors, pollinators, and species of conservation concern. Key debated points: (1) the proposed action increases the land suitable for logging by about 17% and would replace some enforceable standards for fish and wildlife habitat with guidelines — a central conservation concern (guidelines are more discretionary than mandatory standards); (2) large and old trees are a small share of the forest but provide outsized habitat and carbon value; (3) high open-road densities push elk off the national forests onto private land, creating landowner conflict. Alternative 3 is more protective — more large trees retained and wider no-logging buffers along streams. If a species or habitat matters to you, tie it to a specific plan component or standard in your comment.` },

  { title: 'Tribal treaty rights and first foods — CTUIR and Nez Perce', metadata: m({ kind: 'tribal_detail' }), content:
`The three forests lie within lands ceded by treaty, and the Confederated Tribes of the Umatilla Indian Reservation (CTUIR) and the Nez Perce Tribe are central partners. Tribal treaty-reserved rights — hunting, fishing, and gathering — and "first foods" (such as roots, berries, salmon, and game) are a formal part of the analysis. The Forest Service has worked with the tribes as partners, including a CTUIR First Foods restoration strategy and Nez Perce documentation of traditional-use places on the Wallowa-Whitman. Because fish are tied to the stream-protection rules (PACFISH/INFISH) the proposed action would replace, first-foods fisheries are one place treaty rights intersect the logging debate. Tribes are consulted government-to-government, which is distinct from public comment; concerns about treaty rights, first foods, and cultural sites carry particular weight in the record.` },

  { title: 'Economics and jobs — the numbers behind "triple the logging"', metadata: m({ kind: 'economics_detail' }), content:
`Economics is a core argument for the proposed action, and the alternatives differ sharply. Projected first-decade timber volumes and jobs: the proposed action (Alt 2) is roughly 377 million board-feet per year supporting about 3,000–3,050 jobs (on the order of $240 million in annual income); Alternative 3 is about 161 million board-feet per year and roughly 1,415 jobs; and the no-action/status-quo level is about 106 million board-feet per year. So "roughly triple" is the jump from about 106 to about 377 million board-feet. Supporters — mills, timber-dependent towns, counties — point to jobs and community stability; others question whether those harvest levels are ecologically sustainable over the long run. If economics matters to you, name the alternative and the specific local impact (a mill, jobs, county revenue) in your comment.` },
]
...
- Wildfire & fuels: the active-management rationale (dry forests could burn hotter than before); the proposed action removes PACFISH/INFISH stream-protection rules along with the 21-inch rule, replacing them with more flexible provisions; Alt 3 keeps firmer protections.
- Wildlife: species covered (elk, bighorn, marten, raptors, bats); the proposed action adds ~17% more logging-suitable land and swaps some enforceable fish/wildlife standards for guidelines (a central concern); high road densities push elk onto private land; Alt 3 is more protective.
- Tribal treaty rights: CTUIR and Nez Perce as partners; treaty-reserved hunting/fishing/gathering and first foods; the PACFISH/INFISH change touches first-foods fisheries; government-to-government consultation is distinct from public comment.
- Economics & jobs: Alt 2 ≈377 MMBF/yr and ~3,000 jobs (~$240M/yr income); Alt 3 ≈161 MMBF/yr and ~1,415 jobs; status quo ≈106 MMBF/yr — so "triple" is ~106 → ~377.
...
When someone asks "how is it different this time," or how any of these issues (21-inch rule, grazing, access, wildfire, wildlife, Tribal, economics) differ between the versions or across the alternatives, walk them through the specifics above.
